...
```{r cheptels_image_interactif,eval=T,echo=F, message=F, warning=F, fig.width=10,fig.height=10}
...
my_gg <-
  ggplot() +
  geom_sf(data = DEP.s, color = "grey65", fill = NA ,size = 0.2) +

  geom_image(data = grd_data_ctr_img ,aes(x= lon, y = lat,image=img), size=.016) +
...
my_gg
# girafe(
#   ggobj = my_gg, #width_svg = 6, height_svg = 6,
#   options = list(
...
#       css = tooltip_css
#     ),
#     opts_hover(css = "fill:orange;r:6px;")
#   )
# )
