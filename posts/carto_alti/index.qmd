...
showonlyimage: false
draft: false
image: img/img_declivite.png
weight: 0
type: "post"
description: "Altitude ≠ relief"
categories: ["altitude", "relief"]
---
...
scatterD3(data = COMM_alti.df, x = ecart_type, y = moyenne, 
         ...
         colors = c("Grandes villes" = "#284464", "Autres communes" = "#7c9cc1"),
