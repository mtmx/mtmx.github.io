...
Après deux épisodes consacrés aux [enfants](https://mtmx.netlify.app/posts/metrololo_poussettes/) et aux [mamies](https://mtmx.netlify.app/posts/metrololo_mamies/), on rentre dans le tas en abordant un sujet sensible : la gentrification. Parce qu'il semble que tout le monde peut prétendre avoir un avis sur le sujet, je m'y mets aussi.
